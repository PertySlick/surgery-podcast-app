...
<div class="new-pc-row pc-description">
    <div class="new-pc-desc">
        The President of the Association for Surgical Education (Dr. Amalia Cochran) and Chair of the Committee on Graduate Surgical
        Education (Dr. Mo Shabahang) explore the future of surgical education (competency-based training that departs from traditional
        time-in-service models) and share their insights on helping struggling residents. 
    </div>
    <div class="new-pc-duration">01:23:45</div>
</div>
...
<div class="new-pc-row pc-description">
    <div class="new-pc-desc">
        Dr. Douglas Wood, Chair of Surgery at the University of Washington, discusses thoracic surgery, carinal pneumonectomy
        (complete resection of a central tumor that would be deemed unresectable by traditional recommendations), bleeding from the
        hilum, and massive hemoptysis.
    </div>
    <div class="new-pc-duration">01:23:45</div>
</div>
